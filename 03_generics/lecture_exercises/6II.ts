...
class PersonalAccount<N, I> extends CreateAccount<N, I> {
    ...
    constructor(bankName: N, backID: I, on: string) {
        super(bankName, backID);
        this.ownerName = on;
    }
    ...
    showDetails() {
        const totalMoneySpentOnExpenses = Object
            .values(this.recentTransactions)
...
let account2 = new PersonalAccount('Fibank', 100000, 'Peter Petrol');
